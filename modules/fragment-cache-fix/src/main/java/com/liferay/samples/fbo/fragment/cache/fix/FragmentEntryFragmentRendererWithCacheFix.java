package com.liferay.samples.fbo.fragment.cache.fix;
...
public class FragmentEntryFragmentRendererWithCacheFix implements FragmentRenderer {
	...
	private String _renderFragmentEntryLink(
		...
		if (_isCacheable(fragmentEntryLink, fragmentRendererContext)) {
			if (Validator.isNull(portalCache.get(portalCacheKeySB.toString()))) {
